...
def discover_evidence_node(state):
...
def accusation_node(state):
    ...
    return {"officer_output": f"Wrong. The evidence does not support accusing {accused_name}."}
